...
function DetailBar({ title, subtitle, email, icon, toolbar, extra, subtitlePrefix, variant = "light", onRename, onEmail, onBack }) {
  ...
  if (isDark) {
    const content = /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 px-4 py-3", children: [
      onBack && icon && /* @__PURE__ */ jsx(toolback_default, { icon, onClick: onBack, variant: "dark" }),
      !onBack && icon && /* @__PURE__ */ jsx(icon_default, { name: icon, size: 22, className: "text-white/80" }),
      /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0 flex flex-col items-start", children: [
    ...
    if (onBack) {
      return /* @__PURE__ */ jsx("div", { className: "group/header bg-gradient-to-r from-theme-700 to-theme-600", children: content });
    }
    return content;
  }
