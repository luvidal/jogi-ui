...
var LogoUpload = ({
  ...
  return /* @__PURE__ */ jsxs(FieldWrapper, { label, className, visible, children: [
    /* @__PURE__ */ jsxs(
      "div",
      {
        onClick: handleClick,
        ...
        children: [
          loading ? /* @__PURE__ */ jsxs(
          ...
          ) : value && !imgError ? /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx(
              "img",
              {
                src: value,
          ...
          ] }) : /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-2 text-ink-tertiary", children: [
            /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: "w-8 h-8", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-sm", children: "Subir logo" })
          ] }),
          /* @__PURE__ */ jsx(
            "input",
            {
  ...
  "button",
  {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
        typeof item.title === "string" ? /* @__PURE__ */ jsx("div", { className: `text-sm font-medium truncate ${isSelected ? "text-ink-primary" : "text-ink-secondary group-hover:text-ink-primary"}`, children: item.title }) : item.title,
        item.subtitle && (typeof item.subtitle === "string" ? /* @__PURE__ */ jsx("div", { className: "text-xs text-ink-tertiary truncate mt-0.5", children: item.subtitle }) : item.subtitle)
      ] }),
      item.right && /* @__PURE__ */ jsx("div", { className: "flex-shrink-0", children: item.right }),
      isSelected && !item.right && /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 h-1.5 w-1.5 rounded-full bg-brand" })
    ]
  }
);
function CardList({ items, selectedId, onSelect, checkedIds, onCheck }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-1 px-3 py-2", children: items.map((item, i) => /* @__PURE__ */ jsx(
    "div",
    {
...
var Tabs = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className, children: [
    ...
    hasContent && /* @__PURE__ */ jsx("div", { className: "flex-1 min-h-0 flex flex-col", children: typeof children === "function" ? children(displayActiveId) : children })
  ] });
};
