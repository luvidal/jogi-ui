...
var Tabs = ({
  ...
  if (variant === "underline") {
    ...
    const renderTabBar = () => {
      if (!hasGroups) {
        return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex flex-shrink-0", children: tabs.map(renderTabButton) });
      }
      const groups = [];
      let currentGroup = [];
      ...
      return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex flex-shrink-0 gap-6", children: groups.map((group, gi) => /* @__PURE__ */ jsxRuntime.jsx("div", { className: `flex ${rounded && gi === 0 ? "md:first:rounded-tl-btn" : ""} ${rounded && gi === groups.length - 1 ? "md:last:rounded-tr-btn" : ""}`, style: { flex: group.length }, children: group.map((tab, ti) => renderTabButton(tab)) }, gi)) });
    };
