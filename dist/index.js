...
var Modal = ({ title, icon, children, onClose, size: sizeProp = "md", headerActions }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "fixed z-[9999] inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center transition-opacity duration-300", children: /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center justify-between text-ink-primary text-sm px-3 py-2 select-none border-b border-edge-subtle/15", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center", children: [
            /* @__PURE__ */ jsxRuntime.jsx(icon_default, { name: icon ?? "AppWindow", size: 16, className: "me-2 opacity-70" }),
          ...
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-1 select-none", children: [
            headerActions,
            /* @__PURE__ */ jsxRuntime.jsx("div", { className: "cursor-pointer hover:bg-white/10 p-1.5 rounded", onClick: onClose, title: "Cerrar Ventana", children: /* @__PURE__ */ jsxRuntime.jsx(icon_default, { name: "X", size: 16, className: "text-ink-secondary" }) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex-1 overflow-hidden bg-surface-1", children })
      ]
    }
  ) });
};
...
var Skeleton = ({ className = "", variant = "light" }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded ${className}` });
};
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-start justify-between mb-2", children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded-xl w-10 h-10` }),
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded-full w-14 h-4` })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded h-3.5 w-4/5 mb-1.5` }),
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded h-2.5 w-3/5` }),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mt-auto pt-2 flex gap-1 justify-center", children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded w-10 h-4` }),
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded w-10 h-4` })
        ] })
      ]
    }
...
Skeleton.Form = function SkeletonForm({ rows = 4, variant = "light" }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex flex-col gap-4 flex-1", children: Array.from({ length: rows }).map((_, i) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "animate-fade-in space-y-1.5", style: { animationDelay: `${i * 80}ms` }, children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded h-3.5 w-20` }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded-xl h-12 w-full` })
  ] }, i)) });
};
Skeleton.Activity = function SkeletonActivity({ variant = "light" }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-6 flex-1 animate-fade-in", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `rounded-xl border ${card} p-4`, children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "space-y-1.5 flex-1", children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded h-3.5 w-24` }),
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded h-2.5 w-16` })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded h-3.5 w-48` })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "grid grid-cols-2 gap-4", children: [0, 1].map((i) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `animate-fade-in rounded-xl p-4 ${stat} text-center space-y-2`, style: { animationDelay: `${(i + 1) * 80}ms` }, children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded h-8 w-12 mx-auto` }),
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded h-2.5 w-20 mx-auto` })
    ] }, i)) }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `rounded-xl border ${uploads} p-4`, children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded h-3.5 w-32 mb-3` }),
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "space-y-3", children: [0, 1, 2].map((i) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "animate-fade-in flex items-start gap-3", style: { animationDelay: `${(i + 3) * 80}ms` }, children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded w-4 h-4 mt-0.5 flex-shrink-0` }),
...
Skeleton.Preview = function SkeletonPreview({ variant = "light" }) {
  const shimmer = variant === "light" ? "animate-shimmer" : "animate-shimmer-dark";
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute inset-0 flex items-center justify-center animate-fade-in", children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded-xl w-3/4 h-3/4` }) });
};
Skeleton.Table = function SkeletonTable({ rows = 5, variant = "light" }) {
  ...
  const shimmer = isLight ? "animate-shimmer" : "animate-shimmer-dark";
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: `w-full rounded-xl border ${outer} overflow-hidden`, children: Array.from({ length: rows }).map((_, i) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `animate-fade-in flex border-b ${inner} last:border-0`, style: { animationDelay: `${i * 60}ms` }, children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "w-1/3 px-3 py-3", children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded h-3 w-16` }) }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "w-2/3 px-3 py-3", children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded h-3 w-32` }) })
  ] }, i)) });
};
...
Skeleton.DetailBar = function SkeletonDetailBar({
  ...
  const shimmer = variant === "light" ? "animate-shimmer" : "animate-shimmer-dark";
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "relative border-b border-edge-subtle/15 bg-surface-1", children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "relative z-10 flex items-center justify-between px-6 py-4", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
    icon && /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded-xl w-9 h-9 flex-shrink-0` }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-1.5", children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded h-4 w-40` }),
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: `${shimmer} rounded h-3 w-24` })
    ] })
  ] }) }) });
};
...
function DetailBar({ title, subtitle, email, icon, toolbar, extra, subtitlePrefix, variant = "light", onRename, onEmail, onBack }) {
  ...
  if (isDark) {
    if (onBack) {
      return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "group/header bg-surface-2 border-b border-edge-subtle/20", children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-4 px-4 pt-3 pb-1", children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex-1 min-w-0 flex flex-col items-start", children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-1.5 min-w-0 mt-0.5", children: [
              subtitlePrefix && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-sm text-ink-tertiary flex-shrink-0 hidden xl:inline", children: subtitlePrefix }),
              renderSubtitle("text-sm text-ink-secondary"),
              extra && subtitle && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-ink-tertiary", children: "\xB7" }),
              extra
            ] })
          ] })
        ] }),
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-4 px-4 py-3", children: [
      icon && /* @__PURE__ */ jsxRuntime.jsx(icon_default, { name: icon, size: 22, className: "text-ink-secondary" }),
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex-1 min-w-0 flex flex-col items-start", children: [
        renderTitle("text-token-h3 font-semibold text-ink-primary"),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-1.5 min-w-0 mt-0.5", children: [
          subtitlePrefix && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-sm text-ink-tertiary hidden xl:inline", children: subtitlePrefix }),
          renderSubtitle("text-sm text-ink-secondary"),
          extra && subtitle && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-ink-tertiary", children: "\xB7" }),
          extra
        ] })
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative border-b border-edge-subtle/15 bg-surface-1", children: [
    icon && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute -right-3 -bottom-6 opacity-[0.04] pointer-events-none", children: /* @__PURE__ */ jsxRuntime.jsx(icon_default, { name: icon, size: 120, className: "text-brand" }) }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative z-10 flex items-center justify-between px-6 py-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
        icon && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "w-9 h-9 rounded-xl bg-brand/10 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntime.jsx(icon_default, { name: icon, size: 18, className: "text-brand" }) }),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "group flex flex-col min-w-0", children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-1.5 min-w-0", children: [
            subtitlePrefix && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-xs text-ink-tertiary hidden xl:inline", children: subtitlePrefix }),
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-start gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex-1 min-w-0", children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-sm text-ink-secondary", children: toast.message }),
...
var Tabs = ({
  ...
  const lastSelfHealRef = react.useRef(null);
  react.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className, children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "overflow-x-auto overflow-y-hidden mx-3 sm:mx-6 my-2.5 scrollbar-none", children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex w-fit gap-1.5", children: tabs.map((tab) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(
        "button",
        {
          ...
          children: [
            tab.icon && /* @__PURE__ */ jsxRuntime.jsx(icon_default, { name: tab.icon, size: sizeConfig3.icon, className: `flex-shrink-0 ${dark ? isActive ? "text-brand-contrast" : "text-ink-tertiary" : isActive ? "text-theme-500" : "text-gray-400"}` }),
...
function DragHere2({ size = "lg" }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx("style", { children: `
      ...
      ` }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "fixed inset-0 bg-surface-0/60 backdrop-blur-sm pointer-events-none grid place-items-center z-50", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col items-center justify-center gap-3", children: [
      /* @__PURE__ */ jsxRuntime.jsxs(
        "svg",
        {
          width: cfg.svg,
...
function StatusLabel({ item, requestLabel, role, labels }) {
  ...
  if (item.status === "error") return /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-xs text-status-pending", children: item.error || "Error" });
  if (item.status === "detected") return /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-xs text-theme-300 font-medium", children: getDetectedLabel(item.detectedTypes, item.detectedCount) });
  if (item.status === "linking") return /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-xs text-theme-400", children: getLinkingLabel(requestLabel, role) });
  if (item.status === "done" && item.detectedTypes.length > 0) return /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-xs text-status-ok", children: getDetectedLabel(item.detectedTypes, item.detectedCount) });
  const statusLabel = labels[item.status] ?? "";
  return /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-xs text-ink-tertiary", children: statusLabel });
}
...
function UploadCard({ item, index, requestLabel, role, labels }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: `flex-shrink-0 mt-0.5 ${isDone ? "text-status-ok" : "text-theme-300"}`, children: /* @__PURE__ */ jsxRuntime.jsx(icon_default, { name: isDone ? "Check" : item.isExpanded ? "FileText" : fileIcon(item.filename), size: 18 }) }),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center justify-between gap-2", children: [
            /* @__PURE__ */ jsxRuntime.jsx("span", { className: `text-sm font-medium truncate ${isDone ? "text-ink-tertiary" : "text-ink-primary"}`, children: item.isExpanded ? item.filename : truncate(item.filename) }),
...
function UploadCards({ items, summary, requestLabel, role, labels: userLabels }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "fixed inset-0 bg-surface-0/70 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "w-full max-w-md", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center justify-between mb-3 px-1", children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: `text-theme-400 ${!allDone ? "animate-pulse" : ""}`, children: /* @__PURE__ */ jsxRuntime.jsx(icon_default, { name: allDone ? "CircleCheck" : "Upload", size: 18 }) }),
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-sm font-medium text-ink-secondary truncate", children: getHeaderLabel(items, summary) })
      ] }),
      !isSingle && /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "text-xs text-ink-tertiary tabular-nums", children: [
        overallProgress,
        "%"
      ] })
    ] }),
    !isSingle && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-1 rounded-full bg-theme-950/40 mb-3 overflow-hidden", children: /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "bg-surface-1/80 rounded-2xl shadow-token-md border border-edge-subtle/20 divide-y divide-edge-subtle/20 max-h-[60vh] overflow-y-auto", children: items.map((item, i) => /* @__PURE__ */ jsxRuntime.jsx(
      UploadCard,
      {
        item,
        index: i,
