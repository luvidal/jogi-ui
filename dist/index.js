...
var Tabs = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className, children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex w-fit gap-1.5 flex-shrink-0 mx-6 my-2.5", children: tabs.map((tab) => {
...
function UploadCard({ item, index, requestLabel, role, labels }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: `flex-shrink-0 mt-0.5 ${isDone ? "text-status-ok" : "text-theme-400"}`, children: /* @__PURE__ */ jsxRuntime.jsx(icon_default, { name: isDone ? "Check" : item.isExpanded ? "FileText" : fileIcon(item.filename), size: 18 }) }),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex-1 min-w-0", children: [
